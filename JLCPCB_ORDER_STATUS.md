...
It is now September 15, 2026 — over 4 months past the expected delivery date.

## Action Required

If boards have NOT arrived: Contact JLCPCB support at https://jlcpcb.com/user-center/orders/
with order number W2026050802124660.

If boards HAVE arrived and firmware is not yet flashed:
1. Open `production/firmware/wifi_switch.ino` in Arduino IDE
2. Flash to board via USB data cable
